...
public class PrimitiveStreams {
  ...
  public static void main(String[] args) {
    System.out.println("=".repeat(30) + " usingSum " + "=".repeat(30));
    usingSum();

    System.out.println("=".repeat(30) + " ranges " + "=".repeat(30));
    ranges();

    System.out.println("=".repeat(30) + " mappingObjectStreams " + "=".repeat(30));
    mappingObjectStreams();

    System.out.println("=".repeat(30) + " mappingPrimitiveStreams " + "=".repeat(30));
    mappingPrimitiveStreams();

    System.out.println("=".repeat(30) + " maxMinAverage " + "=".repeat(30));
    maxMinAverage();
  ...
  public static void stats(IntStream numbers) {
    var stats = numbers.summaryStatistics(); // terminal operation
