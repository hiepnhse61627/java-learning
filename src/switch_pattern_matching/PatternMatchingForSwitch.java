...
public class PatternMatchingForSwitch {
  ...
  public static void main(String[] args) {
    patternMatchingForSwitch(new Car(2));
    patternMatchingForSwitch(new Car(4));
    patternMatchingForSwitch(new Boat());
    patternMatchingForSwitch(new Vehicle());
    patternMatchingForSwitch(null);
  }

  private static void patternMatchingForSwitch(Vehicle v) {
    System.out.println(
